...
@section('title')
    Outreach Link Agency | Checkout Package
@endsection
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card border border-info">
                        <div class="card-header bg-transparent border-info">
                            <h5 class="my-0 fw-bold text-info">Payable for: Content Order #{{ $content->reference_id }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <h4 class="card-header bg-info text-white">{{ $content->word_content->name }}</h4>
                                        <div class="card-body">
                                            <div class="card-text my-2">
                                                {!! $content->word_content->description !!}
                ...
                <div class="col-lg-6">
                    <livewire:payment-methods :data="$content" :country_list="$country_list" paymentable_type="word_content_checkout"
                                ...
                                <div class="col-12 m-auto px-5">
                                    <div class="stripe-card my-3">
                                        <form method="POST" action="{{ route('stripe.charge') }}" id="payment-form">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" name="paymentable_area" value="stripe_content_order">
