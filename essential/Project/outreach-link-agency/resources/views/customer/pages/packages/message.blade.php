...
@section('title')
    Outreach Link Agency | Package Order Message
@endsection
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0 header-style">Package Order Message</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
            ...
            <div class="row mb-4">
                    ...
                    <div class="card h-100">
                        <div class="card-body">
                            <div class="text-muted">
                                ...
                                <hr>
                                <div>
                                    @if ($packageorder->status == 'Delivered Project')
                                        <p class="mb-1">Action </p>
                                        <form action="{{ route('package-order.packageStatusUpdate', $packageorder->id) }}"
                                            method="POST">
                                            @csrf
                                            @method('PUT')
                                ...
                                <div>
                                    <form action="{{ route('package-order.packageModificationUpdate', $packageorder->id) }}"
                                        method="POST">
                                        @csrf
                            ...
                            <div class="tab-pane active" id="about" role="tabpanel">
                                <div class="table-responsive">
                                    <table class="table mb-0">
                                        ...
                                        <tbody>
                                            @foreach ($packagorderdetails as $item)
                ...
                <div class="row mb-4">
                    ...
                    @foreach ($packageorder->packageOrderModification as $item)
                        <div class="col-xl-4">
