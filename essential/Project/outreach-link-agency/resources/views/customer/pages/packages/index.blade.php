...
@section('title')
    Outreach Link Agency | Package Orders Page
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <span class="mb-0 header-style">Package Orders</span>
                        <a href="{{ route('package-buy.index') }}" class="btn btn-otr-primary waves-effect waves-light"><i
                                    ...
                                    <ul class="btn-group btn-group-sm w-100 p-0 m-0 overflow-auto">
                                        <li class="nav-item btn p-0 {{ request()->get('status') == 'Draft' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            ...
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Draft']) }}">
                                                Draft
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'Waiting for Approval' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Waiting for Approval']) }}">
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'In Progress' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'In Progress']) }}">
                                                In Progress
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'Delivered Project' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Delivered Project']) }}">
                                                Delivered Project
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'Completed' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Completed']) }}">
                                                Completed
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'Modification' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Modification']) }}">
                                                Modification
                                        ...
                                        <li class=" btn p-0  {{ request()->get('status') == 'Declined' ? 'btn-primary' : 'btn-outline-primary' }}"
                                            style="white-space: nowrap; ">
                                            <a class=" nav-link btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view', ['status' => 'Declined']) }}">
                                                Declined
                                        ...
                                        <li class="  btn p-0  {{ request()->get('status') == '' ? 'btn-primary' : 'btn-outline-primary' }} "
                                            ...
                                            <a class="btn btn-sm w-100 p-2" style="color: inherit !important;"
                                                href="{{ route('package-order.view') }}">All
                                                <span class="badge bg-danger text-white font-bold font-size-12">
                                                    {{ $totalCount }}</span>
                                            </a>
                                        </li>
                                    </ul>
                            ...
                            <x-table :headers="[
                                ...
                                @foreach ($package as $item)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-soft-success">{{ $item->quantity }}</span></td>
                                        <td><span class="badge bg-soft-primary">{{ $item->package->price }}</span></td>
                                        <td><span class="badge bg-soft-secondary">{{ $item->total_price }}</span></td>
                                        ...
                                        <td>
                                            @if ($item->payment_status == 'Not Paid')
                                                <a class="btn btn-primary me-2"
                                                    href="{{ route('package-order.checkout', $item->id) }}"
                                                    title="Content Checkout">
                                                    <i class="uil uil-eye"></i>
                                                </a>
                                            @elseif($item->payment_status == 'Paid')
                                                <a class="btn btn-success me-2"
                                                    href="{{ route('packageordershow', $item->id) }}" title="Content Show">
                                                    <i class="uil uil-eye"></i>
                                                </a>
                                            @endif
                                            @if (isset($item->packageOrderModification[0]->messages))
                                                <a title="Message Check"
                                                    href="{{ route('package-order.message', $item->id) }}"
