    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card border border-info">
                        <div class="card-header bg-transparent border-info">
                            <h5 class="my-0 fw-bold text-info">Payable for: {{ $subscription_plan_info->name }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card">
                                        <h4 class="card-header bg-info text-white">{{ $subscription_plan_info->name }}</h4>
                                        <div class="card-body">
                                            <div class="card-text my-2">
                                                {!! $subscription_plan_info->description !!}
                                                <p class="fw-bold mt-3">
                                                    Price: $ {{ $subscription_plan_info->price }}
                                                </p>
                                                <p class="fw-bold">
                                                    Validity: {{ $subscription_plan_info->validity }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-6">
                    <livewire:payment-methods :data="$subscription_plan_info" :country_list="$country_list" :paymentable_area="$paymentable_area" />
                                ...
                                <div class="col-12 m-auto px-5">
                                    <div class="stripe-card my-3">
                                        <form method="POST" action="{{ route('stripe.charge') }}" id="payment-form">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" name="paymentable_area" value="stripe_subscription">
