    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card border border-info">
                        <div class="card-header bg-transparent border-info">
                            <h5 class="my-0 fw-bold text-info">Payable for: {{ $site_order->orderDetails->service->name }}
                                on {{ $site_order->exploreSite->domain }}
                            </h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="card-body">
                                        <table class="prices m-auto table table-borderless -table-responsive w-100">
                                            <tbody class="">
                                                <tr class="border-bottom">
                                                    <td class="text-muted">{{ $site_order->orderDetails->service->name }}
                                                    </td>
                                                    <td class="text-primary"><span
                                                            class="app-currency">{{ $site_order->price }}</span>
                                                    </td>
                                                </tr>
                                            </tbody>
                                            <tfoot class="">
                ...
                <div class="col-lg-6">
                    <livewire:payment-methods :data="$site_order" :country_list="$country_list" paymentable_type="explore_site_checkout"
                                ...
                                <div class="col-12 m-auto px-5">
                                    <div class="stripe-card my-3">
                                        <form method="POST" action="{{ route('stripe.charge') }}" id="payment-form">
                                            @csrf
                                            <div class="row">
                                                <input type="hidden" name="paymentable_area" value="stripe_service_order">
