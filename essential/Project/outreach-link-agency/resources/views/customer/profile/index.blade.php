                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">{{ Str::limit(Auth::user()->name, 25, $end = '..') ?? 'N/A' }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="tab-pane active" id="about" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <form class="outer-repeater" action="{{ route('user-profile.update', Auth::id()) }}"
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <select name="country" class="form-control" id="formname">
                                                            <option value="{{ Auth::user()->country }}">{{ Auth::user()->country ?? 'Select Country' }}</option>
