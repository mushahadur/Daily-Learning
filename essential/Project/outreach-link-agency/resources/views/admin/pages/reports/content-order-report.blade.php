...
@section('title')
    Outreach Link Agency | Content Order Report Page
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <span class="mb-0 header-style">Content Order Report</span>
                    </div>
                </div>
                <div class="card-body">
                    <form action="{{ route('contentOrder.index') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col">
                            ...
                            <x-table :headers="[
                                ...
                                @foreach ($contentorder as $item)
                                    <tr>
                                        ...
                                        <td><span class="badge bg-soft-primary">{{ $item->total_price }}</td>
                                        <td><span class="badge bg-soft-success">{{ $item->quantity }}</td>
