...
@section('title')
    Outreach Link Agency | Coupon Edit Page
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <span class="mb-0 header-style">Coupon Edit Page</span>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                        ...
                                        <form>
                                            <div>
                                                        ...
                                                        <form name="randform">
                                                            ...
                                                            <div class="mb-3 mb-4 d-flex">
                                                                <input type="text" name="couponId_generate"
                                                                    ...
                                                                    value="{{ $coupon->couponId_generate }}">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <textarea class="form-control" name="description" id="billing-address" rows="3" placeholder="type anything...">{{ $coupon->description }}</textarea>
                                                ...
                                                <div class="mb-3 mb-4">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="discount_type"
                                                            id="formRadios1"
                                                            {{ $coupon->discount_type == 'Fixed Amount' ? 'checked' : '' }}
                                                            value="Fixed Amount">
                                        ...
                                        <div class="row">
                                            <div class="table-responsive">
                                                <table class="table table-striped mb-0">
                                                    ...
                                                    <tbody id="container">
                                                        @if (isset($coupon->all_coupon_price))
                                                            <tr>
                                                                <td>
                                                                    <select
                                                                        class="form-control select2-multiple dynamicSelect"
                                                                        name="explore_site[]" id="exploreSiteID">
                                                                        <option>Select</option>
                                                                        <option value="All Services" selected>All
                                                                            Services
                                                                        </option>
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control price-input"
                                                                        placeholder="0.00"
                                                                        value="{{ $coupon->all_coupon_price }}"
                                                                        name="price[All Services]">
                                                                </td>
                                                            </tr>
                                                        @endif
                                                        @if (isset($coupon->exploreSites))
                                                            @foreach ($coupon->exploreSites as $data)
                                                                <tr>
                                                                    <td>
                                                                        <select
                                                                            class="form-control select2-multiple dynamicSelect"
                                                                            name="explore_site[]" id="exploreSiteID">
                                                                            <option>Select</option>
                                                                            @if ($coupon->all_coupon_price == true)
                                                                                <option value="All Services" selected>All
                                                                                    Services
                                                                                </option>
                                                                            @else
                                            ...
                                            <div class="row">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="formCheck1"
                                                        ...
                                                        {{ $coupon->limit_to_one_use_per_customer == 'Limit to one use per customer' ? 'checked' : '' }}>
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="myCheck"
                                                        ...
                                                        {{ $coupon->set_expiry_date == 'Set expiry date' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="myCheck">
                                                        Set expiry date
                                                    </label>
                                                </div>
                                                @if ($coupon->set_expiry_date)
                                                    <div class="row" id="text">
                                                        <div class="col-lg-6">
                                                            <div class="mb-3 mt-2 d-flex">
                                                                <input type="date" name="expiry_date"
                                                                    class="form-control" style="margin-right: 40px"
                                                                    id="tb" placeholder="Never Expires"
                            ...
                            <div class="col">
                                <div class="text-end mt-2 mt-sm-0">
                                    <button type="submit" class="btn btn-otr-primary">
                                        <i class="uil uil-focus-add me-1"></i> Update Coupon </button>
                                </div>
                            </div> <!-- end col -->
                        </div> <!-- end row-->
                    </div>
