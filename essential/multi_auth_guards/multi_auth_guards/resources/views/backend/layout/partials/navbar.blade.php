    ...
    <ul class="navbar-nav navbar-right">
      ...
      <li class="dropdown"><a href="#" data-toggle="dropdown"
        ...
        <div class="dropdown-menu dropdown-menu-right pullDown">
          <div class="dropdown-title">{{ Auth::guard('admin')->user()->username }}</div>
          ...
          <a class="dropdown-item" href="#" onclick="event.preventDefault(); document.getElementById('admin-logout-form').submit();">
            <i class="mr-1 align-middle bx bx-power-off font-size-16 text-danger"></i> Log out
          </a>
          <form action="{{route('admin.logout.submit')}}" method="POST" id="admin-logout-form">
              @csrf
          </form>
        </div>
      </li>
